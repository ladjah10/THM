...
export const questions: Question[] = [
  ...
  },
  {
    ...
    subsection: "Marriage + Family", 
    type: "D",
    text: "We commit to attending church together regularly.",
    options: [
      "We commit to attending church together regularly",
  ...
  },
  {
    ...
    subsection: "Marriage + Family",
    type: "D", 
    text: "We commit to raising our children in the Christian faith.",
    options: [
      "We commit to raising our children in the Christian faith",
      "I do not agree with this statement"
    ],
    weight: 9
  },
  {
    ...
    subsection: "Marriage + Family",
    type: "M",
    text: "Our approach to conflict resolution will be based on:",
    options: [
      "Biblical principles and Christian counseling",
      "Secular therapy and communication techniques", 
