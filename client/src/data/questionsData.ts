...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      "Primarily and only using formula if medically necessary",
      "Primarily breastfeeding with formula supplementation if needed",
  ...
  },
  {
    id: 74,
    section: "Your Health and Wellness",
    subsection: "New Babies: Birth Pain Management",
    type: "M",
    text: "We commit to birth pain management, what is your approach?",
    options: [
      "Natural birth without pain medication",
      "Open to epidural and pain management options",
      "Flexible based on medical recommendations",
      "Not Applicable"
    ],
    weight: 3
  },
  {
    id: 75,
    section: "Your Health and Wellness",
    subsection: "Individual Therapy",
    type: "M",
    text: "We commit to individual therapy when needed, what is your approach?",
    options: [
      "Open to individual therapy when recommended by spouse or counselor",
      "Prefer to work through issues together in couples therapy",
      "Individual therapy as needed for personal growth",
      "Will consider if specific mental health needs arise"
    ],
    weight: 4
  },
  {
