...
export const questions: Question[] = [
  ...
  },
  {
    id: 71,
    section: "Your Finances",
    subsection: "Income: Combining",
    type: "M",
    text: "We commit to combining our income, what is your approach?",
    options: [
      "All income goes into joint account",
      "Percentage of income goes into joint account, rest stays individual",
      "Keep separate accounts but split shared expenses equally",
      "One person's income for household, other for savings/investments"
    ],
    weight: 8
  },
  {
  ...
  },
  {
    id: 73,
    section: "Your Finances",
    subsection: "Budgeting & Recording: Frequency",
    type: "M",
    text: "We commit to budgeting and recording our finances with certain frequency, what is your approach?",
    options: [
      "We commit to a model of reviewing our income, expenses, and savings allocation monthly",
      "We commit to a model of reviewing our income, expenses, and savings allocation weekly",
      "We commit to a model of reviewing our income, expenses, and savings allocation daily",
  ...
  },
  {
    id: 74,
    section: "Your Finances",
    subsection: "Budgeting & Recording: Method/Tools",
    type: "M",
    text: "We commit to budgeting and recording our finances, what is your approach?",
    options: [
      "We commit to a model of tracking our income, expenses, and savings by an application or online software",
      "We commit to a model of tracking our income, expenses, and savings on a simple but well organized spreadsheet",
      "We commit to a model of tracking our income, expenses, and savings on paper",
      "Other approach: Please detail"
    ],
    weight: 4
  },
  {
    id: 75,
    section: "Your Finances",
    subsection: "Budgeting & Recording: By Whom?",
    type: "M",
    text: "We commit to budgeting and recording our finances, what is your approach?",
    options: [
      "Husband takes primary responsibility for tracking income, expenses, and savings with full disclosure to wife",
      "Wife takes primary responsibility for tracking income, expenses, and savings with full disclosure to husband",
      "We share equal responsibility for tracking our income, expenses, and savings",
      "Other approach: Please detail"
    ],
    weight: 3
  },
  {
    id: 76,
    section: "Your Finances",
    subsection: "Debt: Management Model",
    type: "M",
    text: "We commit to managing debt, what is your approach?",
    options: [
      "We are committed to debt freedom and will work together to pay off any existing debt as quickly as possible",
      "We acknowledge debt but will manage it alongside other financial priorities",
      "We will maintain certain types of debt (like mortgage) while eliminating consumer debt",
      "Other approach: Please detail"
    ],
    weight: 6
  },
